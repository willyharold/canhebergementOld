...
use Nanotech\CanhebergementBundle\Entity\Service;
...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $services = $em->getRepository('NanotechCanhebergementBundle:Service')->findAll();
    ...
    {
        $service = new Service();
        $form = $this->createForm('Nanotech\CanhebergementBundle\Form\ServiceType', $service);
    ...
    {
        $deleteForm = $this->createDeleteForm($service);
        $editForm = $this->createForm('Nanotech\CanhebergementBundle\Form\ServiceType', $service);
